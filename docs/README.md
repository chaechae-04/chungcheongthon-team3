...
| 기간 | 활동 | 담당 | 상태 |
|------|------|------|------|
| **7/8** | **아이디어 회의** <br> **기능명세서 작성** | 전체 팀 | ⏳ 예정 |
| **7/9-7/11**  | **와이어프레임 제작** <br> **기술 아키텍처 설계** | FE, Design 팀 <br> BE 팀 | ⏳ 예정 |
| **7/12-7/13** | **UI 설계, 개발 디자인 가이드 작성** <br> **API 명세서 작성** | FE, Design 팀 <br> BE 팀 | ⏳ 예정 |
<!--
