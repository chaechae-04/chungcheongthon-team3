...
### 🎯 주제
```
🏠 라이프스타일 및 산업연계 디지털 콘텐츠
🤖 AI활용 디지털 콘텐츠
🌍 지역문제 해결을 위한 디지털 콘텐츠

중 "AI활용 디지털 콘텐츠 를 활용한 일정 중요도 기반 AI 자동알람"
```
### 📋 기획 단계

| 단계 | 내용 | 상태 |
|------|------|------|
| **문제 정의** | 일정 관리에 어려움을 겪는 사람이 많다. | ✅ 확정 |
| **사용자 분석** | 여러 일정이 많은 대학생 또는 직장인 | ✅ 확정 |

### 💡 솔루션 설계

| 단계 | 내용 | 상태 |
|------|------|------|
| **접근 방법** | 일정 관리에 불편함을 겪는 대학, 직장인 맞춤 일정관리 웹 | 📝 |
| **핵심 기능** | 일정 중요도 관리<br>친구에게 알림<br>일정 분석 | 📝 |
| **차별화** | 일정의 중요도를 AI가 자동으로 부여 | 📝 |

### 🎨 주요 기능

| 기능 | 설명 | 우선순위 | 상태 |
|------|------|----------|------|
| **기능 1** | 캘린더 기능 | 🔥 High | 📝 기획중 |
| **기능 2** | 일정 관리 기능 | 🔥 High | 📝 기획중 |
| **기능 3** | AI 중요도 관리 기능 | 🟡 Medium | 📝 기획중 |
| **기능 4** | AI 분석 기능 | 🟡 Medium | 📝 기획중 |
...
| 기술 | 상태 | 설명 |
|------|------|------|
| **React** | ✅ 확정 | 프론트엔드 프레임워크 |
| **Vite** | ✅ 확정 | 빠른 개발 서버 및 빌드 도구 |
...
|------|------|------|------|
| **7/8** | **아이디어 회의** | 전체팀 | ✅ 완료 |
| **7/8-12** | **기능명세서 작성** | 전체팀 | ⏳ 진행중 |
| **7/12** | **와이어프레임 만들기** | 디자인팀 | ⏳ 진행중 |
| **7/13** | **기술 아키텍처 작성** <br> **API명세서 작성** <br> **개발환경 세팅** | 개발팀 | ⏳ 진행중 |
| **7/13-7/15** | **UI/UX 디자인** | 디자인팀 | ⏳ 예정 |
| **7/15** | **개발 우선순위 확정** <br> **개발 디자인 가이드 작성** | 개발팀 <br> 디자인팀 | ⏳ 예정 |
| **7/16-19** | **FE 기본구조 개발** <br> **BE 기본구조 개발**  | FE팀 <br> BE팀 | ⏳ 예정 |
| **7/19** | **FE 개발 UI 검사 및 피드백** | 디자인팀 | ⏳ 예정 |
| **7/20** | **UI 피드백 전달 및 반영** <br> **BE 코드리뷰 및 피드백** | FE팀 <br> BE팀 | ⏳ 예정 |
| **7/21-24** | **핵심기능 개발** <br> **테스트 가이드 작성** | 개발팀 <br> 디자인팀 | ⏳ 예정 |
| **7/22** | **진행현황 공유 및 중간검사** | 전체팀 | ⏳ 예정 |
| **7/25** | **FE-BE 연동** | 개발팀 | ⏳ 예정 |
| **7/26** | **UI/UX 개선 피드백** | 디자인팀 | ⏳ 예정 |
| **7/27** | **통합 테스트 및 버그수정** | 개발팀 | ⏳ 예정 |
<!--
...
### 📈 일일 진행 상황
- **Day 1**: 아이디어 선정 완료 및 기능명세서 작성 시작
- **Day 2**: 기능명세서 작성 중
- **Day 3**: 일정 재분배
- **Day 4**: OFF
- **Day 5**: 디자인팀 회의 [와이어프레임 제작]
- **Day 6**: 개발팀 회의 [기술 아키텍처 및 API 명세서 공부] 및 개발환경 셋팅 [Docker]
- **Day 7**: 기능명세서, API 명세서, 와이어프레임 제작 중
- **Day 8**: 전체팀 회의 [API 명세서 회의]
- **Day 9**: 개발 파트 분배
- **Day 10**: 개인별 파트 개발 시작
- **Day 11-14**: 개발...ing
<!-- 
