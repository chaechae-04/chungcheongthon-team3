...
|------|------|--------|------|-----------|
| 팀장 | 이영수 | [@chaechae-04](https://github.com/chaechae-04) | [전공] | PM, FE |
| 팀원 | 김태연 | [@github-username](https://github.com/username) | [전공] | FE |
| 팀원 | 정시연 | [@github-username](https://github.com/username) | [전공] | Design |
| 팀원 | 심건보 | [@github-username](https://github.com/username) | [전공] | TL, BE |
| 팀원 | 김다빈 | [@github-username](https://github.com/username) | [전공] | BE |
...
### Frontend
- ✅ **React** - 메인 프론트엔드 프레임워크
- ✅ **Vue.js** - 서브 프레임워크
- ✅ **JavaScript** - 프로그래밍 언어
- ✅ **CSS** - 스타일링
- [ ] CSS Framework (Tailwind, Bootstrap 등)
...
| **7/10-7/11** | 기능 명세서 작성 | PM + 전체 팀 | ⏳ 예정 |
| **7/11-7/12** | 기술 아키텍처 설계 | 개발팀 | ⏳ 예정 |
| **7/12** | 일정 상세화 & 역할 재분배 | PM | ⏳ 예정 |
| **7/13-7/14** | 와이어프레임 제작 | 디자인팀 | ⏳ 예정 |
| **7/14-7/15** | 개발 디자인 가이드 작성 | 디자인팀 | ⏳ 예정 |
| **7/16-7/20** | FE/BE 기본구조 개발 | 개발팀 | ⏳ 예정 |
| **7/21-7/23** | 핵심기능 개발 (연장) | 개발팀 | ⏳ 예정 |
| **7/24-7/25** | FE-BE 연동 & 비즈니스 로직 완성 | 개발팀 | ⏳ 예정 |
...
### 📞 연락처
- **팀장**: 이영수 - leeys4903@naver.com - 010-4903-6881
```

이 README 파일은 해커톤 진행 상황에 따라 계속 업데이트하시면 됩니다! 팀원 정보나 프로젝트 세부사항을 채워넣으시면 완성이에요.
